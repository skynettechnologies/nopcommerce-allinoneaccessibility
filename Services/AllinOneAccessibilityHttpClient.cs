...
namespace Nop.Plugin.Widgets.AllinOneAccessibility.Services
{
    ...
    /// </summary>
    public class AllinOneAccessibilityHttpClient
    {
        #region Fields
        ...
        public AllinOneAccessibilityHttpClient(HttpClient httpClient)
        {
            //configure client
            httpClient.BaseAddress = new Uri("https://www.nopcommerce.com/");
            httpClient.Timeout = TimeSpan.FromSeconds(20);
            httpClient.DefaultRequestHeaders.Add(HeaderNames.UserAgent, AllinOneAccessibilityDefaults.UserAgent);
